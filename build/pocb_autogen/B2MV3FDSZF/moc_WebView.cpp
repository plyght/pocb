...
template <> constexpr inline auto WebView::qt_create_metaobjectdata<qt_meta_tag_ZN7WebViewE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const QColor &)>(16, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 17, 18 },
        }}),
    };
...
void WebView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->themeColorChanged((*reinterpret_cast<std::add_pointer_t<QColor>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (WebView::*)()>(_a, &WebView::closeRequested, 5))
            return;
        if (QtMocHelpers::indexOfMethod<void (WebView::*)(const QColor & )>(_a, &WebView::themeColorChanged, 6))
            return;
    }
}
...
// SIGNAL 6
void WebView::themeColorChanged(const QColor & _t1)
{
