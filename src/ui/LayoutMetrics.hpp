...
inline constexpr int SidebarMinimumWidth = 150;
inline constexpr int SidebarHeaderMinimumWidth = 190;
...
inline constexpr int FloatingSlideInDurationMs = 145;
inline constexpr int FloatingSlideOutDurationMs = 115;
inline constexpr int FloatingSlideTravelPx = 18;
inline constexpr int DockedSidebarTopInset = UnifiedToolbarHeight;
inline constexpr int DockedSidebarLeftInset = 8;
inline constexpr int DockedSidebarRightInset = 0;
inline constexpr int DockedSidebarBottomInset = 8;
inline constexpr int SidebarPanelRadius = 12;
inline constexpr int SidebarPanelPadding = 6;
inline constexpr int SidebarRowHeight = 28;
inline constexpr int ProfileAvatarDiameter = 24;
inline constexpr int ToastInset = 12;
